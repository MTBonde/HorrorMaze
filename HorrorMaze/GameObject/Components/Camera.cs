namespace HorrorMaze
{
    public class Camera : Component
    {
        ...
        public void Awake()
        {
            SceneManager.active_scene.projectionMatrix = Matrix.CreatePerspectiveFieldOfView(MathHelper.ToRadians(45f), GameWorld.Instance.Graphics.GraphicsDevice.Viewport.AspectRatio, 0.1f, 1000f);//sets up the projection matrix to a field of view on 45 degrees
        ...
        public void Update()
        {
            ...
            //makes the camere look at the direction vecors end cordinate from the cameras transform position
