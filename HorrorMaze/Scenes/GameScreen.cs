...
namespace HorrorMaze
{
    public class GameScreen : Scene
    {
        ...
        {
            camTarget = new Vector3(0f, 0f, 0.75f);//look target will be replaced by PlayerController and Camera component
            camPosition = new Vector3(0f, 10f, 0.75f);//the players start location will be replaced by the Camera component later
            ...
            go.AddComponent<MeshRenderer>().SetModel("Cube");
            go.transform.Position3D = new Vector3(0, 0, -1);
        }
        #endregion
    }
}
