...
namespace HorrorMaze
{
    ...
    public static class Globals
    {
        ...
        public static Vector2 CenterWidth = new Vector2(GameWorld.Instance.GraphicsDevice.Viewport.Width / 2);
        public static Vector2 CenterHeight = new Vector2(GameWorld.Instance.GraphicsDevice.Viewport.Height / 2);
